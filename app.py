...
list_kolom = ['Category', 'Rating', 'Type', 'Content Rating', 'Genres','Android Ver']

playstore[list_kolom] = playstore[list_kolom].astype('category')
...
def index():
    ...
    top_category = pd.crosstab(
            index = df2['Category'],
            columns = 'Jumlah')
    top_category = top_category.sort_values(by = 'Jumlah', ascending = False).head().reset_index()
